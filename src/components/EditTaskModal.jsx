...
import { editTask } from '../store/boardSlice.js'
...
export default function EditTaskModal({ task, onClose }) {
  ...
  function handleSubmit(e) {
    ...
    dispatch(editTask({
      taskId: task.id,
      updates: { title: title.trim(), description: description.trim(), priority, dueDate, tag: tag.trim() }
    }))
    onClose()
  }
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: 16, fontWeight: 600, color: '#f1f5f9' }}>Edit task</h2>
